...
public interface ComputerDAO {
	 ...
	 * @return listCompany, a ArrayList containing all the computer in database with every details (id, name, date, date, company)
	 */
	List<Computer> findAll();
	/**
	 * Get all computer from database (but only names and ids)
	 * @return list of Company, a ArrayList containing all the computer in database 
	 */
    ...
    /**
     * Get all the computer with a name starting with the parameter name, an empty array otherwise
     * @param name 
    ...
    /**
     * Update a computer taken in parameter in database
     *  the computer at the id(Parameter) by the computer in Parameter
     * @param id id of the computer to update
     * @param computer will replace the computer at id = id(Parameters)
