			...
			<div id="actions" class="form-horizontal">
				<div class="pull-left">
					<form id="searchForm" action="#" method="GET" class="form-inline">
						...
						<input type="search" id="searchbox" name="search" class="form-control" placeholder="${searchname}" /> <input type="submit" value="${filternames}" id="searchsubmit" class="btn btn-primary"></input>
					</form>
				</div>
				<div class="pull-right">
					<mylib:link classe="btn btn-success" id="addComputer" target="addcomputer">
						<spring:message code="add" text="Add" />
					</mylib:link>
					<a class="btn btn-default" id="editComputer" onclick="$.fn.toggleEditMode();"><spring:message code="edit" text="Edit" /></a>
			...
			<table class="table table-?page=1&nbElements=50#striped table-bordered">
				<thead>
					<tr>
						...
						<th class="editMode" style="width: 60px; height: 22px;"><input type="checkbox" id="selectall" /> <span style="vertical-align: top;"> - <mylib:link target="#" id="deleteSelected" onclick="$.fn.deleteSelected();">
						...
						<th><mylib:link target="#" order="discontinued">
								<spring:message code="discontinued.date" text="Discontinued date" />
							</mylib:link></th>
